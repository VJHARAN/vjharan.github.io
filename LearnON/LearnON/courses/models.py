...
class Subjects(models.Model):
    ...
    image_case = models.ImageField(upload_to='course_images', default='default.jpg')
...
class Lesson(models.Model):
    slug = models.SlugField()
    title = models.CharField(max_length=30)
    case = models.ForeignKey(Subjects,on_delete=models.CASCADE)
    ...
    def get_absolute_url(self):
        return reverse("courses:lesson_detail", kwargs={"course_slug": self.case.slug,'lesson_slug':self.slug})
